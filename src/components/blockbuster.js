...
export default function Blockbuster({overhead, title, description, background, imgPos = 'object-top'}) {
  ...
  return (
    <section className={`relative flex flex-col justify-end min-h-[60vh] w-screen md:mb-0 mx-auto pt-12 md:py-20 ${bg}`}>
      <div className="absolute inset-0 bg-gradient-to-tr from-black to-transparent opacity-80 z-10"/>

      <div className="container mx-auto z-20">
        <div className="flex flex-col md:flex-row items-stretch justify-stretch">
          <div className="md:w-2/3 p-8 md:p-14">
